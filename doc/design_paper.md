...
These are just a few examples of requirements of a token. In the following chapter we will investigate how the commonly used tokens, ERC20 or ERC721 on Ethereum, fulfill these requirements. 
