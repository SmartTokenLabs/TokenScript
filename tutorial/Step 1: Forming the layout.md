...
This code enables you to render the token we are about to create and defines all the appropriate logic such as the styling, images(in base64) and how to render the timestamp encoded in our NFT token. 
